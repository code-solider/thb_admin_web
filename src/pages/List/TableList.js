...
class TableList extends PureComponent {
    ...
    columns = [
        ...
        },
        {
            ...
            key: '_id',
            render: (text) => (
                <a onClick={() => this.handleGetUserById(text)}>编辑</a>
            ),
        },
    ];
        ...
        form.validateFields(async (err, fieldsValue) => {
            ...
            await this.setState({
                where:{
                    ...
                    regTime:fieldsValue.regTime===undefined?undefined:Number(fieldsValue.regTime)===1?{$ne:''}:''
                }
            });
            let data = {
                where: {
    ...
    render() {
        ...
        const { selectedRows, modalVisible, updateModalVisible, stepFormValues, drawerVisible } = this.state;
        const menu = (
