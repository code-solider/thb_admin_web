...
class Page extends Component {
                    ...
                    <Col md={6} sm={24}>
                        <span className={styles.submitButtons}>
                          ...
                          <Button style={{ marginLeft: 8 }} onClick={this.handleFormReset}>
                            ...
                            <Button style={{ marginLeft: 40 }} onClick={() => this.showDrawer('addCompanyVisible')} type="primary">
                            新增公司
                          </Button>
                        </span>
                    </Col>
    ...
    render() {
        ...
        return (
            <Fragment>
                <AddCompanyDrawer
                    drawerVisible={addCompanyVisible}
                    onClose={this.onClose}
                />
                <UpdateCompanyDrawer
                    drawerVisible={updateCompanyVisible}
                    onClose={this.onClose}
                />
