...
export async function updateUserDataById(payload) {
  return request(`/user`, {
    method: 'put',
    data: payload,
    headers: { Authorization: await getAuth('/user') },
  }).then(data => data.data);
}
...
export async function delCompanyById(id) {
  return request(`/company/${id}`, {
    method: 'delete',
    headers: { Authorization: await getAuth(`/company/${id}`) },
  }).then(data => data);
}
...
export async function updateCompanyById(payload) {
  return request(`/company`, {
    method: 'post',
    data: payload,
    headers: { Authorization: await getAuth(`/company`) },
  }).then(data => data);
}
...
export async function delArtById(id) {
  return request(`/art/${id}`, {
    method: 'delete',
    headers: { Authorization: await getAuth(`/art/${id}`) },
  }).then(data => data);
}
...
export async function updateSys(payload) {
  return request(`/sys`, {
    method: 'put',
    data: payload,
    headers: { Authorization: await getAuth('/sys') },
  }).then(data => data);
}
